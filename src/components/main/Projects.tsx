...
const projectsData = [
  {
    title: 'Face Recognition Attendance System (2025)',
    description: 'Analyzed & preprocessed real-time image data with OpenCV to improve face-detection accuracy. Built a KNN-based classification model to identify faces from live video input, paired with a Flask interface for reviewing records and storing data reliably in SQLite with validation checks.',
    imageURL: '/face-recognition-attendance.jpg',
    github: 'https://github.com/Rajufhh',
    tags: ['Python', 'Flask', 'OpenCV', 'SQL', 'SQLite', 'KNN Classifier', 'Data Analysis'],
    highlights: [
      'Preprocessed live image data with OpenCV using exploratory profiling techniques',
      'Implemented KNN classification model for real-time video facial recognition',
      'Designed Flask management interface for staff attendance verification',
      'Integrated SQLite database with pre-write data validation checks'
    ]
  },
  {
    title: 'AI-Assisted Applications (2025)',
    description: 'Engineered AI-driven applications including a weather intelligence tool and task manager, translating complex user requirements into structured outputs using advanced prompt engineering (role-based, instruction-based, chained).',
    imageURL: '/scheduly-ai.png',
    github: 'https://github.com/Rajufhh',
    tags: ['Prompt Engineering', 'ChatGPT', 'Gemini', 'Lovable', 'Python', 'AI/LLM'],
    highlights: [
      'Developed interactive apps with ChatGPT, Gemini & Lovable',
      'Iterated on chained and role-based prompt architectures',
      'Ensured consistent, structured output formats and error handling'
    ]
  },
  {
    title: 'Feedback Management System (2025)',
    description: 'Developed a menu-driven Java application to collect, structure, and manage student feedback. Applied modular OOP principles (encapsulation, inheritance, polymorphism) and input validation using Java Collections to ensure clean downstream analytics and reporting.',
    imageURL: '/portfolio-project.png',
    github: 'https://github.com/Rajufhh',
    tags: ['Java', 'OOP', 'Data Validation', 'Collections', 'Data Management'],
    highlights: [
      'Modular architecture using core OOP principles',
      'Strict input validation via Java Collections framework',
      'Structured reporting pipeline for student feedback analysis'
    ]
  },
]
              ...
              <BentoGridItem
                ...
                description={
                  <div className="space-y-3 text-sm text-foreground mt-2">
                    ...
                    {project.highlights && (
                      <ul className="space-y-1 my-2 text-xs text-foreground/90">
                    ...
                    <div className="flex flex-wrap gap-1.5 pt-1">
                      {project.tags.map(t => (
                        <span key={t} className="px-2 py-0.5 rounded-md text-[11px] bg-primary/10 text-primary font-medium">
                          {t}
                        </span>
                      ))}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-3 pt-2">
                      <Badge asChild variant="secondary" className="gap-1 rounded-full px-3 py-1">
                        <a
                ...
                header={
                  <div className="relative w-full min-h-[12rem] sm:min-h-[14rem] rounded-xl overflow-hidden shadow-inner">
                    <Image
