...
const initialArticles: Blog[] = [
  {
    id: 1,
    title: "Exploratory Data Analysis: Uncovering Hidden Anomalies in Real-World Datasets",
    excerpt: "A structured methodology for profiling dataset distribution, identifying outliers, and performing data hygiene before model ingestion.",
    image: "/face-recognition-attendance.jpg",
    href: "https://github.com/Rajufhh",
    tags: ["Data Analysis", "EDA", "Python", "Profiling"],
    createdAt: "2025-01-10",
  },
  {
    id: 2,
    title: "Writing Resilient Data Validation Pipelines with Python & SQL",
    excerpt: "How pre-write data validation and schema integrity checks prevent dirty data leaks in SQLite and MySQL transactional workflows.",
    image: "/scheduly-ai.png",
    href: "https://github.com/Rajufhh",
    tags: ["SQL", "Data Validation", "Python", "Databases"],
    createdAt: "2025-01-25",
  },
  {
    id: 3,
    title: "KNN Classification for Real-Time Feature Matching and Recognition",
    excerpt: "Exploring K-Nearest Neighbors for high-dimensional feature comparison, distance metrics, and fast decision boundaries.",
    image: "/portfolio-project.png",
    href: "https://github.com/Rajufhh",
    tags: ["Machine Learning", "KNN", "Python", "Data Analysis"],
    createdAt: "2025-02-05",
  },
]

export function BlogsSection() {
  const [blogs] = useState<Blog[]>(initialArticles)
  ...
  return (
    <section id="blogs" className="relative w-full py-20 bg-background overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 title="Articles & Insights" className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-foreground via-primary to-blue-500 bg-clip-text text-transparent mb-4">
            Articles & Insights ✍️
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            Practical insights on exploratory data analysis, SQL optimizations, data validation, and Python pipelines.
          </p>
        </motion.div>
        ...
        <div className="grid gap-4">
          {filteredBlogs.length === 0 ? (
            ...
            >
              <p className="text-muted-foreground text-lg">
                No articles match the selected tags. Try selecting different tags.
              </p>
            </motion.div>
          ) : (
          ...
          >
            ...
            >
              <div className="relative z-10">Explore All Work on GitHub</div>
