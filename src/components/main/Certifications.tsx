...
// Raju Bathini's Verified Certifications
const certificationsData = [
  {
    Image: "/python.svg",
    title: "HackerRank — Python (Basic)",
    description: "Validates foundational Python programming, algorithmic logic, and data structure manipulation.",
    issued: "2024",
    links: [
      {
        link_name: "HackerRank",
  ...
  },
  {
    ...
    description: "Demonstrates proficiency in relational database querying, filtering, table joins, and aggregations.",
    issued: "2024",
    links: [
      {
        link_name: "HackerRank",
  ...
  },
  {
    ...
    description: "Verifies core knowledge of Java syntax, OOP architecture, and Java Collections framework.",
    issued: "2024",
    links: [
      {
        link_name: "HackerRank",
  ...
  {
    Image: "/character.png",
    title: "Cisco Academy — PCAP: Python",
    description: "Comprehensive certification covering PCAP: Programming Essentials in Python by Cisco Networking Academy.",
    issued: "2024",
    links: [
      {
        link_name: "Cisco NetAcad",
  ...
  {
    Image: "/mainIcons.svg",
    title: "SmartInterviews — SmartCoder",
    description: "Verified problem-solving mastery in Data Structures, Algorithms, and optimized code execution.",
    issued: "2024",
    links: [
      {
        link_name: "SmartInterviews",
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground mt-2 max-w-3xl mx-auto text-base font-semibold md:text-lg italic">
              Verified certifications demonstrating strong programming, problem-solving, and SQL database querying foundations.
            </p>
          </div>
        </motion.div>
