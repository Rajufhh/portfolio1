...
export const metadata: Metadata = {
  title: 'Data Analysis Best Practices - Guide by Raju Bathini',
  description: 'Comprehensive guide to exploratory data analysis, data cleaning, validation, and SQL optimization by Raju Bathini.',
  keywords: [
  ...
  alternates: {
    canonical: 'https://raju-bathini.vercel.app/blog/devops-best-practices',
  },
  openGraph: {
    title: 'Data Analysis Best Practices - Complete Guide',
    description: 'Comprehensive guide to exploratory data analysis, data cleaning, and SQL validation.',
    type: 'article',
    publishedTime: '2025-01-15T00:00:00.000Z',
    authors: ['Raju Bathini'],
  },
}
        ...
        <article>
          <header className="mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
              Data Analysis & Validation Best Practices
            </h1>
            <div className="flex items-center gap-4 text-muted-foreground mb-6">
              <span>By Raju Bathini</span>
              <span>•</span>
