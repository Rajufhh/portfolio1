...
export const metadata: Metadata = {
  title: 'Data Analyst - Raju Bathini | Python, SQL, EDA & ML Expert',
  description: 'Professional Data Analyst specializing in Python, SQL, Exploratory Data Analysis, and machine learning models. Turning raw data into actionable insights.',
  keywords: [
    'data analyst',
  ...
  alternates: {
    canonical: 'https://raju-bathini.vercel.app/devops-engineer',
  },
}
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
            Data Analyst - Raju Bathini
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed">
            Computer Science graduate skilled in Python, SQL, exploratory data analysis, data cleaning, 
