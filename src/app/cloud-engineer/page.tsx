...
export const metadata: Metadata = {
  title: 'Data Solutions & Engineering - Raju Bathini',
  description: 'Data analytics portfolio showcasing expertise in Python, SQL, database validation, and machine learning models.',
  keywords: [
    'data analyst',
    'data engineering',
    'python sql analyst',
  ...
  alternates: {
    canonical: 'https://raju-bathini.vercel.app/cloud-engineer',
  },
}
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
            Data Analytics & Engineering - Raju Bathini
          </h1>
          <p className="text-xl text-muted-foreground leading-relaxed">
            Specializing in data pipelines, exploratory analysis, SQL query design, and analytical tools.
          </p>
        </header>
